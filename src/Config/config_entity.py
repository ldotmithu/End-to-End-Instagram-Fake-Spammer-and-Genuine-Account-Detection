...
class DataIngestionConfig:
    ...
    URL:str="https://github.com/ldotmithu/Dataset/raw/refs/heads/main/clean_data.zip"
    local_data_path:Path = "artifacts/data_ingestion/data.csv"
    unzip_dir :Path = "artifacts/data_ingestion"

@dataclass
class DataValidationConfig:
    root_dir:Path = "artifacts/data_validation"
    data_path:Path = "artifacts\data_ingestion\clean_data.csv"
